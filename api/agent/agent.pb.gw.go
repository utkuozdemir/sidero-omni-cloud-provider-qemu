...
func request_AgentService_GetIPMIInfo_0(ctx context.Context, marshaler runtime.Marshaler, client AgentServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetIPMIInfoRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetIPMIInfo(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AgentService_GetIPMIInfo_0(ctx context.Context, marshaler runtime.Marshaler, server AgentServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetIPMIInfoRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetIPMIInfo(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAgentServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AgentServiceServer) error {
	...
	mux.Handle("POST", pattern_AgentService_GetIPMIInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/management.AgentService/GetIPMIInfo", runtime.WithHTTPPathPattern("/management.AgentService/GetIPMIInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AgentService_GetIPMIInfo_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AgentService_GetIPMIInfo_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAgentServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AgentServiceClient) error {
	...
	mux.Handle("POST", pattern_AgentService_GetIPMIInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/management.AgentService/GetIPMIInfo", runtime.WithHTTPPathPattern("/management.AgentService/GetIPMIInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AgentService_GetIPMIInfo_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AgentService_GetIPMIInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"management.AgentService", "GetIPMIInfo"}, ""))
)

var (
	forward_AgentService_SetIPMICredentials_0 = runtime.ForwardResponseMessage

	forward_AgentService_GetIPMIInfo_0 = runtime.ForwardResponseMessage
)
